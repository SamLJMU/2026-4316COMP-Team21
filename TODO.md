...
- Implement input and validation functions in the `input.py` file
- Implement function that reads the csv file and extract data into a format matplotlib can interpret
- Rename the constants name in the `constants.py` into the appropriate menu option it is associated to.
