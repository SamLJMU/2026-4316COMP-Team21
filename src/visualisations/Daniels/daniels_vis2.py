...
def userdata_uv_index():
    ...
    plot_uv_index(date_filtered_dataset, selected_countries, start_date, end_date)
            
# Function to make the graph
def plot_uv_index(dataset, country_list, start_date, end_date):
