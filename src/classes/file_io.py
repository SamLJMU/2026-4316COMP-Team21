...
class FileIO:
    ...
    unique_countries: None | list[str] = None
    unique_timezones: None | list[str] = None
    ...
    def read_file(cls):
        ...
        print_success("Dataset Transformed.")

        print_info("Caching...")
        cls.unique_countries = cls.dataset_df["country"].unique()
        cls.unique_timezones = cls.dataset_df["timezone"].unique()
        print_info("Cached.")
