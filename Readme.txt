...
3) Outputs:
    a) different graphs providing different insights into the data
    b) Minimum, Maximum and Average Values for key columns
    c) Unit conversion (e.g. Celsius to Fahreneit, mph to kmh)

Questions/Queries to implement:
